...
| Strains | `StrainEntry` | BacDive strain id, designation, `culture_collection_ids`, `is_type_strain`, `medium_count`; capped at 200 per record, `strain_count` gives the total |
