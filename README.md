...
**63,699 taxon records** are currently committed.

| Domain | Records | | Rank | Records | | Attested by | Records |
|---|---:|---|---|---:|---|---|---:|
| BACTERIA | 55787 | | SPECIES | 39592 | | NCBITAXON | 63699 |
| EUKARYOTA | 6242 | | STRAIN | 22518 | | GTDB | 46772 |
| ARCHAEA | 1661 | | NO_RANK | 862 | | GOLD | 43822 |
| OTHER | 9 | | SUBSPECIES | 498 | | MADIN | 34147 |
|  |  | | FORMA_SPECIALIS | 94 | | BACDIVE | 26241 |
|  |  | | ISOLATE | 44 | | LPSN | 22469 |
|  |  | | VARIETAS | 33 | | MEDIADIVE | 14153 |
|  |  | | SEROTYPE | 26 | | BACTOTRAITS | 9625 |
|  |  | | SEROGROUP | 18 | |  |  |
|  |  | | FORMA | 7 | |  |  |
|  |  | | BIOTYPE | 6 | |  |  |
|  |  | | CLADE | 1 | |  |  |

These records contain 103,214 BacDive strain classifications and 69,119 listed strain occurrences, representing 64,272 distinct listed strains. Species and descendant records can list the same strain; 34 records cap their listing. 19651 records list a type strain, 21254 carry an LPSN correct name, 46772 map to GTDB (173,091,952 genomes summed across record attestations, not deduplicated), and 0 carry causal graphs (0 evidence-backed edges).

**19,481 listed strains have genome identifier links.** Coverage below is deduplicated across records, with NCBI assemblies first:

| Database | Strain–identifier pairs | Distinct identifiers | Distinct strains |
|---|---:|---:|---:|
| NCBI | 57,329 | 57,180 | 19,171 |
| GTDB | 16,070 | 16,029 | 11,663 |
| PATRIC | 16,890 | 16,890 | 11,695 |
| IMG | 19,000 | 18,950 | 14,663 |
| AllTheBacteria | 4,907 | 4,894 | 4,528 |
...
|---|---:|---:|---:|
| BIOSAMPLE | 21,806 | 21,610 | 14,200 |
| BIOPROJECT | 31,395 | 13,992 | 14,327 |
| GOLD_ORGANISM | 72,571 | 72,263 | 33,002 |
| GOLD_PROJECT | 20,813 | 20,629 | 13,739 |
| GOLD_ANALYSIS | 18,544 | 18,504 | 13,545 |
| STRAININFO_STRAIN | 49,264 | 48,789 | 48,903 |
| STRAININFO_DEPOSIT | 101,329 | 101,007 | 48,903 |
| NUCLEOTIDE_SEQUENCE | 50,969 | 50,723 | 9,839 |
...
**0 records are `REVIEWED`;** the remaining 63699 are `SEEDED` or `PROPOSED`.
