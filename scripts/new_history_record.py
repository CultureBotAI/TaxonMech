...
The schema is already vendored at `src/taxonmech/schema/history.yaml`, which is
...
Usage:
    python scripts/new_history_record.py --kind record --slug escherichia_coli \\
        --target-root data/taxa/bacteria --event EDIT --outcome changed \\
...
REPO_URL = "https://github.com/CultureBotAI/TaxonMech"
